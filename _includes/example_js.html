<script src="{{site.wlan_url}}/js/dataTables.bootstrap.js"></script>
<script >
/**
...
var example = {
    ...
    "init": function () {
        var user_share_data = {
            ...
            title: "网友共享",
            url: "{{site.wlan_url}}/assets/example/user_share_json.txt",
            divId: "user_share"
        };
        ...
        var basic_init_data = {
            ...
            title: "基本初始化",
            url: "{{site.wlan_url}}/assets/example/basic_init_json.txt",
            divId: "basic_init"
        };
        ...
        var advanced_init_data = {
            ...
            title: "高初始化",
            url: "{{site.wlan_url}}/assets/example/advanced_init_json.txt",
            divId: "basic_init"
        };
        ...
        var styling_data = {
            ...
            title: "样式",
            url: "{{site.wlan_url}}/assets/example/styling_json.txt",
            divId: "styling"
        };
        ...
        var data_sources = {
            ...
            title: "数据源",
            url: "{{site.wlan_url}}/assets/example/data_sources_json.txt",
            divId: "data_sources"
        };
        ...
        var api_sources = {
            tableId: "api_table",
            title: "API",
            url: "{{site.wlan_url}}/assets/example/api_json.txt",
            divId: "api"
        };
        ...
        var ajax_sources = {
            tableId: "ajax_table",
            title: "AJAX",
            url: "{{site.wlan_url}}/assets/example/ajax_json.txt",
            divId: "ajax"
        };
        ...
        var server_side_sources = {
            ...
            title: "Server-side",
            url: "{{site.wlan_url}}/assets/example/server_side_json.txt",
            divId: "server_side"
        };
        ...
        var plug_ins_sources = {
            ...
            title: "Plug-ins",
            url: "{{site.wlan_url}}/assets/example/plug_ins_json.txt",
            divId: "plug_ins"
        };
        ...
        var vedio1_sources = {
            ...
            url: "{{site.wlan_url}}/assets/example/vedio_json.txt",
            divId: "vedio1"
        };
        ...
        var vedio2_sources = {
            ...
            title: "",
            url: "{{site.wlan_url}}/assets/example/vedio_user_share_json.txt",
            divId: "vedio2"
        };
    ...
    "dailyInit":function(){
        var daily_sources = {
            ...
            title: "",
            url: "{{site.wlan_url}}/assets/daily/2016-04_json.txt",
            divId: ""
        };
        ...
        var daily_05_sources = {
            ...
            title: "",
            url: "{{site.wlan_url}}/assets/daily/2016-05_json.txt",
            divId: ""
        };
